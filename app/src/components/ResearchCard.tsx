            ...
            <div className="flex justify-between items-center">
                ...
                <div className="flex gap-4 items-center">
                    <div className="flex gap-2 fill-dark-blue-40">
                        {properties?.files?.find((file: any) => file.type === 'application/pdf') ? <Document /> : null}
                        ...
                        {properties?.files?.find((file: any) => file.type === 'application/pdf' || file.type === 'application/pptx') ? <Slides /> : null}
                        {properties?.files?.find((file: any) => file.type === 'application/code') ? <Code /> : null}
                    </div>
                    {/* @ts-ignore  */}
