...
const ResearchCard = ({ title, author, tag, doi, status }: ResearchCardProps) => {
    return (
        <div className="bg-white p-5 w-[800px] border rounded-lg">
            <div className="flex items-start mb-6">
                <div className="grow mr-10">
                    <h2 className="text-lg font-medium mb-2 text-dark-blue-80">{title}</h2>
                    <p className="font-medium text-dark-blue-60">{author}</p>
                </div>
                <Tag label={tag} />
            </div>
            <div className="flex justify-between items-center">
                <p className="text-sm text-default-100">DOI: {doi}</p>
                <div className="flex gap-4 items-center">
                    <div className="flex gap-2 fill-dark-blue-40">
                        <Document />
                        <Data />
